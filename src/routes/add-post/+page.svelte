...
<header class="bg-white py-4 shadow-md top-0 z-10">
...
<form class="container mx-auto p-5" method="POST" enctype="multipart/form-data">
    <label for="dropzone" class="mb-3 flex flex-col items-center justify-center w-full h-64 border-z border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50">
        ...
        <input bind:files name="image" id="dropzone" type="file" accept="image/png,image/jgeh" class="hidden" required/>
    </label>
    <div class="mb-3">
